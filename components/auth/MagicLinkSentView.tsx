    ...
    <div className="flex min-h-screen items-center justify-center bg-page px-4 py-12">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="mt-8 rounded-feature border border-border bg-surface p-6 shadow-card sm:p-8">
          ...
          <p className="mt-4 font-display text-headline-md text-ink">Vérifiez votre boîte mail</p>
          <p className="mt-2 text-sm text-ink-muted">
            Un lien de connexion a été envoyé à <span className="font-medium text-ink">{email}</span>. Ouvrez-le sur
            cet appareil pour continuer.
          </p>

          <div className="mt-6 border-t border-dashed border-border pt-5">
            <p className="text-xs text-ink-muted">
              Pas de vraie boîte mail ici — cette démonstration simule la réception.
            </p>
            <button
              type="button"
            ...
            >
              {sending ? "Ouverture du lien…" : "J'ai cliqué le lien"}
            </button>
          </div>
        </div>
      </div>
