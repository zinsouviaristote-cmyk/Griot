...
function MusicStaffDecoration() {
  return (
    <svg
      viewBox="0 0 500 500"
      className="pointer-events-none absolute -top-10 left-5 h-[480px] w-[480px] text-brand/40"
      fill="none"
      aria-hidden="true"
    >
      <path
    ...
    <section className="relative scroll-mt-[var(--nav-clearance)] overflow-hidden px-4 pb-10 pt-16 sm:pb-14 sm:pt-20 lg:pt-24">
      <div className="relative mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-16">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <h1 className="mt-6 font-display text-3xl font-extrabold leading-[1.15] tracking-tight text-ink sm:text-5xl sm:leading-[1.1] md:text-6xl">
        ...
        <div className="relative flex flex-col items-center justify-center animate-fade-in duration-1000">
          ...
          <div className="relative z-10 h-72 w-72 overflow-hidden rounded-full border-4 border-surface shadow-xl transition-transform duration-500 hover:scale-105 sm:h-80 sm:w-80">
            <Image
