...
export function CreateSongHero() {
  ...
  return (
    <div className="relative">
      {/* `relative` sur la section (pas seulement ce wrapper) : l'ordre DOM place
          les arcs derrière, et le fond opaque de la carte recouvre la portion
          des arcs qui traverserait son intérieur — voir ResonanceRings.tsx. */}
      <ResonanceRings />
      <section className="relative rounded-feature border border-border bg-surface px-5 py-10 text-center shadow-card sm:px-8 sm:py-14">
